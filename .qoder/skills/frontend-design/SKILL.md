...
description: Guides creation of distinctive, production-grade frontend interfaces that avoid generic "AI slop" aesthetics. Use when building components, pages, applications, or interfaces, or when the user asks for frontend design, UI creation, or visual implementation work.
---

# Frontend Design

This skill guides creation of distinctive, production-grade frontend interfaces with exceptional attention to aesthetic details and creative choices. Implement real working code — never generic placeholders.
...
- No two designs should be the same. Vary between light and dark themes, different fonts, different aesthetics.
