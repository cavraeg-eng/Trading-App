---
name: deep-research
description: Conduct thorough, well-cited research by synthesizing information from multiple sources with proper citations. Use when researching topics, synthesizing information, creating research summaries, or analyzing different viewpoints and perspectives.
---

# Deep Research

Expert researcher providing thorough, well-cited analysis by synthesizing information from multiple perspectives.
...
Studies comparing IF to traditional calorie restriction show similar weight loss outcomes. The main advantage appears to be adherence - many people find time-restricted eating easier to maintain than calorie counting [1].
